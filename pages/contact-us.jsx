                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="text-base leading-relaxed mb-6 sm:mb-9 text-body-color">
                                    Your feedback, complaints, and suggestions are crucial in helping us improve our services and meet your expectations. We are here to listen and address your concerns, so please don't hesitate to reach out to us
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">
                                            H.No: 3-50, Hanuman temple street, Pedda amberpet, Hyderabad, 501505
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <a className="text-base text-body-color underline" href="tel:+919505629940">
                                            (+91) 95056 29940
                                        </a>
                                    </div>
                                </div>
                                <div className="mb-2 sm:mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <a className="text-base text-body-color underline" href="mailto:contact@bestelectro.in">
                        ...
                        <div className="mt-0 sm:mt-20 w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                                <form action="https://formsubmit.co/saimani.bandaru@gmail.com" method="POST">
