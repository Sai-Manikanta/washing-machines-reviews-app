export const data = [
  {
    ...
    rating: 9.2,
    highlights: [
      "Adapts to Hard Water: Maintains the softness and color of your clothes even when washing in hard water conditions.",
      "Express Wash: Offers a 50% faster wash for all wash programs, saving you time.",
      "Quick Water Filling: Fills the tub 50% faster, even with low water pressure as low as 0.017MPa.",
      "7.5Kg Capacity: Top-Load, Fully Automatic washing machine.",
      "BEE 5 Star Rating: Recognized for high energy efficiency, reducing utility costs.",
      "Ideal for Large Families: Suitable for family sizes of 6-8 members.",
      "12 Wash Programs: Provides a variety of wash programs for versatile cleaning options.",
      "Advanced Technologies: Includes Power Scrub Technology, Spiro Wash, and Hard Water Wash Technology for enhanced cleaning.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7.5 Kg",
  ...
  },
  {
    ...
    rating: "8.8",
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, offers great wash quality, and is easy to use.",
      "Capacity 7 Kg: Suitable for families with 3 to 4 members, meeting standard laundry needs.",
      "Manufacturer Warranty: Includes a 2-year comprehensive warranty on the product for added peace of mind.",
      "Wash Programs: Offers a variety of wash programs, including Normal, Quick Wash, Soak+Normal, Delicates, Eco Tub Clean, and Energy Saving (6 in total) for versatile cleaning options.",
      "Digital Inverter: Enjoy a long-lasting, powerful performance with reduced energy consumption and noise levels.",
      "Key Features: Child Lock, Diamond Drum, Magic Filter, Monsoon, Center Jet, Tempered Glass Window, and 5 Levels for enhanced washing performance and convenience.",
      "Included in the Box: 1 Washing Machine Unit, 1 User Manual, 1 Installation Guide for a complete setup.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg ",
  ...
  },
  {
    ...
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, offers great wash quality, and is easy to use.",
      "Capacity 6.5 Kg: Suitable for families with 3 to 4 members, accommodating their laundry needs.",
      "Extended Warranty: For all Fully Automatic Washing Machines with Digital Inverter Motor, sold on or after 1st Dec 2022, the warranty period on the Digital Inverter Motor is revised from 10 years to 20 years, and the Comprehensive Product Warranty is revised from 3 years to 2 years. For clarifications, contact Customer Care at 1-800-5-726-7864 (1-800-5-SAMSUNG) or 1-800-40-726-7864 (1-800-40-SAMSUNG). Terms and Conditions apply.",
      "Wash Programs: Offers 9 wash programs for versatile cleaning options.",
    ],
    specs: {
      type: "Top Load",
      capacity: "6.5 Kg",
  ...
  },
  {
    ...
    rating: "8.4",
    highlights: [
      "5 Star Energy Rated Model: Recognized for best-in-class efficiency. Features Smart Cleaning, Child Lock, Smart Diagnosis, Normal Pulsator, and 3-Step Wash.",
      "Capacity 7.0 Kg: Suitable for families with 3 to 4 members. Fully-Automatic Top Load Washing Machine that is easy to use.",
      "Special Features: TurboDrum for enhanced washing performance, Tub Clean to sterilize the inner and outer tub, preventing unpleasant odors.",
      "Smart Inverter Technology: An energy-saving technology with a revolutionary water-proof motor that doesn't corrode and is highly durable.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg",
  ...
  },
  {
    ...
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, offers great wash quality, and is easy to use.",
      "Capacity 7 Kg: Suitable for 3 – 4 members, accommodating average laundry needs.",
      "Energy Star Rating: 5 Star - Recognized as best in class for energy efficiency, reducing utility costs.",
      "Manufacturer Warranty: Comes with a 2-year comprehensive warranty on the product and an impressive 20-year warranty on the Digital Inverter Motor for added peace of mind.",
      "Motor: 700 RPM: Higher spin speeds ensure faster wash and drying, making it ideal for busy households or those looking for quick and effective laundry solutions.",
      "Wash Programs: Offers 9 Wash Programs, including Quick Wash, Bedding, Delicates, Eco Tub Clean, Energy Saving, Jeans, Normal, Rinse + Spin, and Delay End for versatile cleaning options.",
      "Drum Type: Diamond | Pulsator: Dual Storm - Ensures effective washing performance.",
      "Panel Display: Features a Red LED display and is suitable for washing in hard water conditions.",
      "Key Performance Features: Quick Wash, Magic Filter - Enhances washing performance and efficiency.",
      "Special Features: Eco Bubble Technology, BubbleStorm, Dual Storm, Soft Closing Door, Water Level: 5 Levels, Auto Restart, Rat Protection, Rust-Proof Body, Tempered Glass Window, Child Lock for added convenience and performance.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg",
    ...
    videoReview: {
      title:
        "Samsung 7 Kg, 5 star, Eco Bubble Technology, Digital Inverter Motor, Dual Storm, Fully-Automatic Top Load Washing Machine (WA70BG4441YYTL, Lavender Gray)",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/3qXrFYT",
      flipkart:
  ...
  },
  {
    ...
    rating: 8.5,
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, offers best wash quality, and is easy to use with an in-built heater.",
      "Capacity 6.5 Kg: Suitable for 3 – 4 members per wash, accommodating standard laundry needs.",
      "Energy Rating: 5 Star - Recognized as best in class for energy efficiency, reducing utility costs.",
      "Warranty: Includes a 2-year comprehensive warranty and an impressive 10-year warranty on the motor for added peace of mind.",
      "Motor: 740 RPM - Higher spin speed results in faster drying, making laundry more efficient.",
      "Wash Programs: Provides 12 Wash Programs, including Daily, Heavy, Delicate, Whites, Stainwash, Anti-Bac, Woollens, Bedsheet, Eco Wash, Rinse + Spin, Spin, and Wash Only for versatile cleaning options.",
      "Key Performance Features: Offers 3 Hot Water Modes, ZPF Technology, In-Built Heater, Removes 50 Tough Stains, and 6th Sense Technology for enhanced washing performance.",
      "Additional Features: Delay Wash, Dynamix, Spiro Wash, Auto Tub Clean, Express Wash, and Removes 48-Hour-Old Stains for added convenience and performance.",
      "Drum: Steel | Body Material: Stainless Steel - Ensures durability and effective cleaning.",
    ],
    specs: {
      type: "Top Loading",
      capacity: "6.5 Kg",
  ...
  },
  {
    ...
    productImage: {
      url: "https://m.media-amazon.com/images/I/41u7XFd7KAL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.4",
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Offers great wash quality, easy to use; Capacity 6.5 Kg: Suitable for bachelors & couples; Energy Rating: 5 Star - Recognized for best-in-class efficiency; Warranty: Tri Shield Protection - 4 years complete machine warranty, 10 years motor warranty, 10 years spare part support.",
      "Triadic Pulsator: Provides a 3 Way Wash Action for Deep Cleaning; 8 Wash Programmes: Includes Smart Sense, Express, Jeans, Delicates, Wash, Rinse, Spin, 3D Wash System for versatile cleaning options.",
      "720 RPM: Higher spin speeds result in faster drying; Key Features: Aqua Energie Device for Water Softening, Better Detergent Action & Color Protection, Active Color Protection, Lint Tower Filter, Biaxial 360-degree Rotation for cleaning every part, Triadic Pulsator for Deep Cleaning, SmartSense for enhanced washing performance.",
      "Installation Type: Free Standing - Provides installation flexibility.",
    ],
    specs: {
      type: "Top Load",
      ...
      functionType: "Fully Automatic",
      weight: "35 Kg",
      rotationSpeed: "720 RPM",
    },
    specialFeatures:
      "Aqua Energie, Aqua Conserve, Protective Rat Mesh, Lint Tower Filter, Child Lock, Machine Level Indicator, Programe Memory Backup, Hard Water Wash, Auto Imbalance System, High Low Voltage Protection, Active Color Protection, 3D Wash System",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/45ChlVh",
      flipkart: "",
    },
  },
  {
    productName:
      "Panasonic 6.7 Kg Built-in Heater Fully-Automatic Top Loading Washing Machine (NA-F67BH8MRB,Middle free silver,Active Foam System) with Water Reuse",
    productImage: {
      url: "https://m.media-amazon.com/images/I/31gIItcp-qL._SY445_SX342_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.6",
    highlights: [
      "Affordable top-load washing machine with a built-in heater and excellent wash quality",
      "6.7 Kg capacity, suitable for families of 3 to 4 members",
      "Manufacturer Warranty: 2 years on the product and 10 years on the motor",
      "10 customizable wash programs to meet your specific requirements",
      "Active Foam System efficiently removes stains from every crevice of your clothes",
      "Built-In Heater ensures hot water for thorough sterilization, ideal for infant clothes and towels",
      "Water Reuse Course for conserving water during the second wash cycle",
      "Large lint filter for effortless cleaning, capable of holding plenty of lint",
      "Includes inlet hose, drain pipe, anti-rat cover, snap ring, screw, and owner's manual in the box",
      "1.5 meters inlet pipe and 0.8 meter outlet pipe included",
    ],
    specs: {
      type: "Top Load",
      ...
      functionType: "Fully Automatic",
      weight: "31 Kg",
      rotationSpeed: "702 RPM",
    },
    specialFeatures: "In built heater",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/45sLypP",
      flipkart:
  ...
  },
  {
    ...
    productImage: {
      url: "https://m.media-amazon.com/images/I/41OXhznwPIL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.2",
    highlights: [
      "Fully-Automatic Washing Machine: Offers an economical and efficient solution with low water and energy consumption, combining washing and drying functions.",
      "Capacity 8 Kg (wash): Suitable for large families, accommodating substantial laundry needs.",
      "5 Star Energy Rated Washing Machine: Recognized for its energy efficiency, saving more than 2 buckets of water with every wash.",
      "Manufacturer Warranty: Includes a 2-year warranty on the product and a 5-year warranty on the motor (T&C apply) for added assurance.",
      "700 RPM: Higher spin speeds contribute to faster drying, making laundry more efficient.",
      "12 Wash Programs: Provides versatile options, including Normal, Quick Wash, Gentle, Soak, Eco Wash, Saree, Air Dry, Tub Clean, Wash + Rinse, Wash + Spin, Rinse + Spin, and Spin.",
      "Body Material: Light grey PCM rust-free (metal) - Ensures durability and longevity.",
      "Special Features: Child Lock, Water Level Selection, Delay - Enhances user convenience and control.",
    ],
    specs: {
      type: "Top Load",
    ...
    specialFeatures: "Child Lock, Water Level Selection, Delay",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/3Pq3oEu",
      flipkart:
  ...
  //   rating: "8.4",
  //   highlights: [
  //     "Fully Automatic Top Load Washing Machines: Designed for ergonomic use and deliver excellent wash quality.",
  //     "700 RPM: Higher spin speed results in shorter drying time, improving laundry efficiency.",
  //     "Number of Wash Programs: Offers 10 versatile wash programs for different laundry needs.",
  //     "5 Star Rating: Recognized for its energy efficiency and performance.",
  //     "Capacity: 8 Kg - Suitable for larger families, accommodating substantial laundry loads.",
  //   ],
  //   specs: {
  //     type: "Top Load",
  //     capacity: "8 Kg",
...
//       "Express Wash gives 50% faster* wash for all wash programs.",
//       "Fills tub 50% faster* even when the pressure is as low as 0.017MPa.",
//       "7.5Kg, Top Load, Fully Automatic",
//       "BEE 5 Star Rating",
...
//       "Smart Inverter Technology: An Energy Saving Technology And It Is Revolutionary Water Proof Motor Doesn'T Corrode And Is The Most Durable One In Its League",
...
//       "Wash Programs: 9 Wash Programs – Quick Wash, Bedding, Delicates, Eco Tub Clean, Energy Saving, Jeans, Normal, Rinse + Spin, Delay End",
//       "Drum type : Diamond| Pulsator : Dual Storm|",
//       "Panel Display : Red LED, Suitable for hard water washing",
//       "Key Performance Features: Quick Wash, Magic Filter",
...
//       "Wash Programs : 12 Wash Programs – Daily | Heavy | Delicate | Whites | Stainwash | Anti-Bac | Woollens | Bedsheet | Eco Wash | Rinse + Spin| Spin | Wash Only",
...
//       "10 Wash Programs allow to customize the wash cycle as per the users requirements",
...
//       "Water Reuse Course: Enables to preserve water for Second wash Cycle.",
//       "Big Lint Filter: Large capacity lint filter is Installed to ensure effortless cleaning. It can hold plenty of lint and hard-to-remove lint can be easily washed away with water easily",
...
//     rating: "8.2",
//     highlights: [
//       "Fully-Automatic washing Machine: Economical, Low water and energy consumption, involves manual effort; Has both washing and drying functions",
//       "Capacity 8 Kg (wash): Suitable for large families",
//       "5 Star Energy Rated Washing Machine : Save More than 2 Buckets of Water , with Every Wash",
//       "Manufacturer Warranty: 2 years on product, 5 years on motor T&C",
//       "700 RPM: Higher spin speeds helps in faster drying",
//       "12 Wash Programs - Normal,Quick Wash,Gentle,,Soak,Eco Wash,Saree,Air Dry,Tub Clean,Wash + Rinse,Wash + Spin,Rinse + Spin,Spin",
//       "Body Material Light grey PCM rust free(metal)",
//       "Special Feature : Child Lock, Water Level Selection, Delay",
