export const data = [
  {
    ...
    productImage: {
      url: "https://m.media-amazon.com/images/I/41UftvEzGFL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.4",
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable and offers the best wash quality, even with hard water conditions.",
      "Capacity 7 Kg: Suitable for households with 3 – 4 members per wash, accommodating average laundry needs.",
      "Energy Rating: 5 Star - Recognized as the best-in-class for energy efficiency, saving on utility costs.",
      "Warranty: Comes with a 2-year comprehensive warranty and a 5-year warranty on the motor for added peace of mind.",
      "Motor: 740 RPM - The higher spin speed contributes to faster drying, making laundry more efficient.",
      "Wash Programs: Includes 12 wash programs for versatile cleaning options, such as Daily, Heavy, Delicate, and more.",
      "Key Performance Features: Dry Tap Sensing (machine detects water supply issues), ZPF Technology, Smart Sensor, Delay Wash for added convenience.",
      "Additional Features: Express Wash, 123 Wash, Low Noise Level, Spiro Wash for enhanced performance.",
      "Drum: Steel | Body Material: Stainless Steel - Ensures durability and efficient cleaning.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg",
    ...
    specialFeatures: "Hard water wash, 5 star energy rating, High RPM motor",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/3R6J9wM",
      flipkart:
  ...
  {
    productName:
      "Panasonic 6.5 Kg 5 Star Fully-Automatic Top Load Washing Machine (2022 Model, NA-F65LF2MRB, Grey, 12 Wash Program, Active Foam Wash Technology, Antibacterial Water Inlet)",
    productImage: {
      url: "https://m.media-amazon.com/images/I/31G1B0RwYBL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.6",
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, great wash quality, and easy to use. Offers intensive stain and germ removal.",
      "Capacity 6.5 Kg: Suitable for families with 2 to 3 members, meeting average laundry needs.",
      "5 Star Energy Rating: Recognized as best-in-class for energy efficiency, reducing utility costs.",
      "Manufacturer Warranty: Comes with a 2-year warranty on the product and an impressive 10-year warranty on the motor for added peace of mind.",
      "1380 RPM: High spin speed ensures faster washing and drying, saving time and energy.",
      "12 Wash Programs: Includes various wash programs, such as quick wash, delicate wash, and ecowash, for versatile cleaning options.",
      "Wings Type Pulsator and Rust-Proof Metal Body: Ensures effective washing performance and durability.",
      "Key Performance Features: Aqua Spin Rinse, Active Foam Wash Technology, Quick Wash, Overheating Control, Auto Power Off with Memory Backup for added convenience and efficiency.",
      "Additional Features: Big Lint Filter, Child Lock, Air Dry, Error Alarm, Auto Balancing for hassle-free operation.",
    ],
    specs: {
      type: "Top Load",
      capacity: "6.5 Kg",
    ...
    specialFeatures:
      "Active Foam System, Aqua Spin Rinse, 5 Star Rating, 12 Washing Programs, Quick Wash,",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/44FFSrj",
      flipkart:
  ...
  {
    productName:
      "Whirlpool 6 Kg 5 Star Royal Fully-Automatic Top Loading Washing Machine (WHITEMAGIC ROYAL 6 GENX, Grey, Hard Water Wash, ZPF Technology)",
    productImage: {
      url: "https://m.media-amazon.com/images/I/41drTvRrAeL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.4",
    highlights: [
      "Fully Automatic Top Load Washing Machine: Affordable, provides the best wash quality, and is easy to use, even with hard water conditions.",
      "Capacity 7.5 Kg: Suitable for 3 – 4 members per wash, accommodating average laundry needs.",
      "Energy Rating: 5 Star - Recognized as the best-in-class for energy efficiency, with an annual energy consumption of 360 Watts.",
      "Motor: 740 RPM - The higher spin speed ensures faster drying, making laundry more efficient.",
      "Drum: Steel | Body Material: Stainless Steel - Ensures durability and efficient cleaning.",
      "Warranty: Comes with a 2-year comprehensive warranty and a 5-year warranty on the motor for added peace of mind.",
      "12 Wash Programs: Includes various wash programs, such as Normal, Heavy, Delicates, and more, for versatile cleaning options.",
      "Key Performance Features: Hard Water Wash, 123 Wash, Dry Tap Sensing, Smart Sensor for enhanced washing performance.",
      "Additional Features: Aqua Store, Auto Tub Clean, Spiro Wash, ZPF Technology, Express Wash, Low Noise Level for added convenience and performance.",
    ],
    specs: {
      type: "Top Load",
      capacity: "6 Kg",
    ...
    specialFeatures:
      "Hard Water Wash Programme, Extra Durable Body & Low Noise, 740 RPM Fast Motor for Quick Drying",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/3Z0XjBi",
      flipkart:
  ...
  },
  {
    ...
    highlights: [
      ...
      "Digital Inverter: Enjoy long-lasting, powerful performance with less energy consumption and noise.",
      "Key Features: Child Lock, Diamond Drum, Magic Filter, Monsoon, Center Jet, Tempered Glass Window, 5 Levels for enhanced washing performance and convenience.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg",
  ...
  },
  {
    ...
    productImage: {
      url: "https://m.media-amazon.com/images/I/31g28R49rAL._SX342_SY445_QL70_FMwebp_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.6",
    highlights: [
      ...
      "5 Star Energy Rating: Recognized as best in class for energy efficiency, saving on utility costs.",
      "Manufacturer Warranty: Includes a 2-year warranty on the product and an impressive 10-year warranty on the motor.",
      "680 RPM: Higher spin speed results in shorter drying times, making laundry more efficient.",
      "Customized 8 Wash Programs: Tailored for different fabric types. Features Magic Filters to effectively trap dirt during washing, ensuring dirt-free clothes.",
      "Rustproof Durable Metal Body with Stainless Steel Drum: Ensures durability and effective cleaning.",
      "Key Performance Features: Aquabeat Wash ensures thorough cleaning, FUZZY Technology and One Touch Smart Wash measure the weight of clothes, Soft Closing Lid and LED Display, Memory of power interrupt for added convenience.",
      "Additional Features: Child Lock, Detergent Dispenser, Error Alarm, Auto Unbalancing Detection for hassle-free operation.",
      "Inlet Pipe: 1.25 meters, Outlet Pipe: 0.8 meter included in the package for easy setup.",
    ],
    specs: {
      type: "Top Load",
      capacity: "6 Kg",
    ...
    specialFeatures: "Fuzzy Control Technology",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/45YmfeX",
      flipkart:
  ...
  // },
  {
    ...
    productImage: {
      url: "https://m.media-amazon.com/images/I/51x0Aqk4-ML._SX679_.jpg",
      alt: "Washing Machine Photo",
    },
    rating: "8.4",
    highlights: [
      "Fully-Automatic Top Load Washing Machine: Affordable, offers great wash quality, and is easy to use.",
      "Capacity 7 Kg: Suitable for small families, accommodating their laundry needs.",
      "Manufacturer Warranty: Includes a 2-year warranty on the product and an impressive 10-year warranty on the motor for added peace of mind.",
      "801 Spin RPM: Higher spin speed results in faster drying times, making laundry more efficient.",
      "Wash Programs: Provides a variety of 8 wash programs for versatile cleaning options.",
    ],
    specs: {
      type: "Top Load",
      capacity: "7 Kg",
    ...
    specialFeatures:
      "Bionic Magic Filter, Childlock, PCM Cabinet, Balance Clean Pulsator, Oceanus Wave Drum",
    videoReview: {
      title: "",
      id: "",
    },
    stores: {
      amazon: "https://amzn.to/3qQCbBn",
      flipkart:
...
//       "Capacity 7 Kg: Suitable for 3 – 4 members per wash",
//       "Energy Rating : 5 Star - Best in class efficiency",
//       "Warranty : 2 Comprehensive Warranty, 5years on motor",
...
//       "Key Performance Features :Dry Tap Sensing (The machine intuitively detects and indicates if there is no water supply either through the tap or a filter blocked with foreign objects) | ZPF Technology | Smart Senor | Delay Wash",
...
//     rating: "8.6",
//     highlights: [
//       "Fully-Automatic Top Load Washing Machine: Affordable with Great Wash Quality, Easy to Use | Intensive Removal of Stains and Germs",
//       "Capacity 6.5 Kg: Suitable for families with 2 to 3 members",
//       "5 Star: Best in class efficiency",
//       "Manufacturer Warranty: 2 years on product and 10 years on Motor",
//       "1380 RPM: High Spin speed helps in faster washing and drying",
//       "12 Wash Programs including quick wash, delicate wash, ecowash and much more",
//       "Wings type pulsator and Rust Proof Metal body",
//       "Key Performance Features: Aqua Spin Rinse: For the first rinse, a powerful shower over a wide area effectively washes away foam. Compared to the conventional way of rinsing by soaking, this achieves water saving of up to 28% | Active Foam Wash Technology: Creates fine, high-density foam before the washing cycle starts. The foam lifts, separates and removes dirt particles from deep within the fibres | Quick Wash: The washing machine can weigh the load accurately and accordingly select the appropriate washing program as well as the water level | Overheating Control | Auto Power off with Memory Backup",
//       "Additional Feautures: Big Lint Filter: Large capacity lint filter is Installed to ensure effortless cleaning. It can hold plenty of lint and hard-to-remove lint can be easily washed away with water easily, Child Lock, Air Dry, Error Alarm, Auto Balancing",
...
//     rating: "8.4",
//     highlights: [
//       "Washing Machine Fully Automatic top load washing machine : Affordable with best wash quality and easy to use with Hard Water Wash",
//       "Washing Machine Fully Automatic Capacity 7.5 Kg : Suitable for 3 – 4 members per wash",
...
//       "Washing Machine Fully Automatic come with 12 Wash Programs : Normal | Heavy | Delicayes | Whites | Stainwash | Eco Wash | Woolens | Bedsheets | Rinse + Dry | Dry | Wash Only | Aqua Store",
//       "Key Performance Features : Hard Water Wash | 123 Wash | Dry Tap Sensing | Smart Sensor",
...
//       "Rustproof Durable Metal Body with Stainless Steel drum",
//       "Key Performance Features: Aquabeat Wash- Ensure thorough cleaning, and fresh clothes after each wash using 3 different levels of water force | FUZZY Technology & One Touch Smart Wash-These functions can measure the weight of clothes and match with the corresponding water level and appropriate washing program, which makes it easier for users to deal with your laundry | Soft Closing Lid and LED Display | Memory of power interrupt",
//       "Additional Features: Child Lock, Detergent Dispenser, Error Alarm, Auto Unbalancing detection",
...
//     highlights: [
//       "Fully-automatic top load washing machine: Affordable with great wash quality, Easy to use",
//       "Capacity 7 Kg: Suitable for small families",
//       "Manufacturer warranty: 2 years on product, 10 years on motor",
//       "801 Spin RPM: higher spin speeds helps in faster drying",
