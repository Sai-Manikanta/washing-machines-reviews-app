...
import WatchVideoReview from '../components/WatchVideoReview'

const ProductCard = ({ washingMachineData }) => {
    const { orderNumber, productName, rating, highlights, productImage, stores, videoReview } = washingMachineData;

    return (
        <div className="bg-white p-4 pt-10 rounded-md drop-shadow-sm relative">
            <div>
                <Image
                ...
                <span className="text-2xl absolute top-6 left-7 text-slate-700">
                    {orderNumber}
                </span>
            </div>
            <h2 className="mt-4 text-slate-900 line-clamp-3">
                {productName}
            </h2>
            <Disclosure>
                {({ open }) => (
                    <>
                        <div className="flex justify-between items-center mt-4">
                            ...
                            <Disclosure.Button className="flex gap-x-2 cursor-none items-center">
                        ...
                        <Disclosure.Panel className="text-slate-700 mt-4">
                            ...
                            <ul className="list-disc list-inside space-y-3 text-sm mt-3">
                                {highlights.map((text, i) => <li key={i} className="leading-6">{text}</li>)}
                            </ul>
                            <hr className="my-3" />
                        </Disclosure.Panel>
                    </>
            ...
            <div className="flex gap-x-3 mt-4">
                <a href={stores.amazon} target="_blank" className="border-2 rounded bg-slate-100 flex-grow flex justify-center items-center">
                    <svg
                ...
                <a href={stores.flipkart} target="_blank" className="border-2 rounded bg-slate-100 flex-grow  flex justify-center items-center">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                        ...
                        <g clipPath="url(#f)" fill="none" stroke="#D1D1D1" strokeWidth={2}>
