      ...
      <div className="bg-white p-4 pt-10 sm:py-8 sm:px-10 rounded-md drop-shadow-sm relative sm:flex">
        ...
        <div className="flex-grow">
          ...
          <a
                ...
                target="_blank"
                className="bg-yellow-400 border-x-1 border-b-4 border-yellow-500 font-extrabold rounded bg-slate-100 flex justify-center items-center w-44 hover:brightness-[95%]"
              >
              ...
              <a
                ...
                href={stores.amazon}
                target="_blank"
                className="bg-yellow-400 border-x-1 border-b-4 border-yellow-500 font-bold rounded bg-slate-100 flex justify-center items-center w-44 hover:brightness-[95%]"
              >
